...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view
{
    ...
    if (view == nil)
    {
        ...
        label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, _width, _height/2)];
        label.textAlignment = NSTextAlignmentCenter;
        label.font = [label.font fontWithSize:30];
        label.tag = 1;
        
        catLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, _height/2, _width, _height/2)];
        catLabel.textAlignment = NSTextAlignmentCenter;
        catLabel.font = [label.font fontWithSize:15];
        catLabel.tag = 2;
...
- (void)carouselDidEndDragging:(iCarousel *)carousel willDecelerate:(BOOL)decelerate
{
    if(decelerate == FALSE)
    {
        ...
        [_delegate getPriceForSelectedIndex:_selectedIndex];
        [_carousel reloadData];
    }
}
